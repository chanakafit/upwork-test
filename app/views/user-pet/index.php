...
<section id="show-form">
    ...
    <div class="pets-container" data-id="0">
        ...
        <div id="success-msg" class="text-success" style="display: none;"><p>
                ...
                <span class="text-secondary"><i style="margin-left:1rem ;" class="fa fa-times fa-lg"
                                                onclick="successmsg()"></i></span></p>
            <p>
            </p></div>
        ...
        <div class="wrapper">
            ...
            <ul class="selected-pets  js-selected" id="selected-options"
                style="display: <?= $isPetsAvailable ? 'block' : 'none' ?>;">
                <?php foreach ($pets as $pet): ?>
                    <li><input type="checkbox" name="sd_pets[]" value="5" class="selected-checkbox"
                               id="selected-checkbox-5"
                               style="display: <?= $isPetsAvailable ? 'none' : 'inline-block' ?>;">
                        <div class="content-container">
                            <div class="image-container"><img src="<?= Yii::$app->homeUrl . $pet->imageFile ?>"
        ...
        <div class="btns-container">
            ...
            <div class="icons">
                ...
                <i id="delete-btn" class="fa fa-trash delete" data-label="when-saved"
